...
void main() {
  final evtTypes = [EvtTypeRec(id: 1, name: "one"), EvtTypeRec(id: 2, name: "two"), EvtTypeRec(id: 3, name: "three")];
  test("empty", () {
  ...
  test("simple (day)", () {
    ...
    // evts during 2 days
    final evts = [
      EvtRec.inCurrentTZ(typeId: 2, start: t.add(Duration(hours: 1)), end: t.add(Duration(hours: 2))),
      EvtRec.inCurrentTZ(typeId: 1, start: t.add(Duration(hours: 2)), end: t.add(Duration(hours: 3))),
      EvtRec.inCurrentTZ(typeId: 2, start: t.add(Duration(hours: 5)), end: t.add(Duration(hours: 5, minutes: 30))),
      EvtRec.inCurrentTZ(typeId: 3, start: t.add(Duration(hours: 25)), end: t.add(Duration(hours: 25, minutes: 30))),
    ];
  ...
  test("simple with gap (week)", () {
    ...
    final evts = [
      EvtRec.inCurrentTZ(typeId: 2, start: t.add(Duration(hours: 1)), end: t.add(Duration(hours: 2))),
      EvtRec.inCurrentTZ(typeId: 1, start: t.add(Duration(hours: 50)), end: t.add(Duration(hours: 52))),
      EvtRec.inCurrentTZ(
        typeId: 2,
