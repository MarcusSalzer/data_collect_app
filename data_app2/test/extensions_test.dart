...
void main() {
  group('DateTime Utilities', () {
    ...
    test('endOfMonth', () {
      expect(DateTime(2026, 1, 1).endOfMonth, DateTime(2026, 2));
      expect(DateTime(2026, 3, 14).endOfMonth, DateTime(2026, 4));
      expect(DateTime(2026, 12, 3).endOfMonth, DateTime(2027, 1));
    });
